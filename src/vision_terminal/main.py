"""VisionTerminal CLI entry point (Typer)."""
...
app = typer.Typer(
    ...
    help="VisionTerminal — fast image and video processing in the terminal.",
)
...
def main(
    ...
    if version:
        cli_ui.console.print(f"[bold cyan]VisionTerminal[/] v{__version__}")
        raise typer.Exit()
